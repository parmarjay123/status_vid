...
public abstract class PartySticker {
    ...
    @NonNull
    PartySticker setFlippedHorizontally(boolean flippedHorizontally) {
    ...
    @NonNull
    PartySticker setFlippedVertically(boolean flippedVertically) {
    ...
    PartySticker setMatrix(@Nullable Matrix matrix) {
    ...
    public abstract PartySticker setDrawable(@NonNull Drawable drawable);

    @NonNull
    public abstract Drawable getDrawable();

    @NonNull
    public abstract PartySticker setAlpha(@IntRange(from = 0, to = 255) int alpha);
    ...
    void getBoundPoints(@NonNull float[] points) {
    ...
    void getMappedPoints(@NonNull float[] dst, @NonNull float[] src) {
        matrix.mapPoints(dst, src);
    }
    ...
    private void getBound(@NonNull RectF dst) {
    ...
    private void getMappedBound(@NonNull RectF dst, @NonNull RectF bound) {
    ...
    void getCenterPoint(@NonNull PointF dst) {
    ...
    void getMappedCenterPoint(@NonNull PointF dst, @NonNull float[] mappedPoints,
                              @NonNull float[] src) {
        getCenterPoint(dst);
        src[0] = dst.x;
        src[1] = dst.y;
    ...
    boolean contains(@NonNull float[] point) {
        ...
        PartyStickerUtils.trapToRect(trappedRect, unrotatedWrapperCorner);
