...
public class PartyBitmapStickerIcon extends PartyDrawableSticker implements PartyStickerIconEvent {
    ...
    static final int RIGHT_BOTOM = 3;
    ...
    private PartyStickerIconEvent iconEvent;

    PartyBitmapStickerIcon(Drawable drawable, @Gravity int gravity) {
        super(drawable);
    ...
    public PartyStickerIconEvent getIconEvent() {
        return iconEvent;
    }

    void setIconEvent(PartyStickerIconEvent iconEvent) {
