...
public class PartyAlbumFile implements Parcelable, Comparable<PartyAlbumFile> {
    ...
    public PartyAlbumFile() {
    }

    @Override
    public int compareTo(PartyAlbumFile o) {
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof PartyAlbumFile) {
            PartyAlbumFile o = (PartyAlbumFile) obj;
    ...
    protected PartyAlbumFile(Parcel in) {
        mPath = in.readString();
    ...
    public static final Creator<PartyAlbumFile> CREATOR = new Creator<PartyAlbumFile>() {
        @Override
        public PartyAlbumFile createFromParcel(Parcel in) {
            return new PartyAlbumFile(in);
        }

        @Override
        public PartyAlbumFile[] newArray(int size) {
            return new PartyAlbumFile[size];
        }
    };
